...
extension FirestoreManager {
    ...
    // Alle Transferprozesse abrufen
    func getTransferProcesses() async throws -> ([TransferProcess], DocumentSnapshot?) {
        let snapshot = try await db.collection("transferProcesses")
