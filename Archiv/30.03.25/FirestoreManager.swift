...
class FirestoreManager {
    ...
    func getAllClients(lastDocument: DocumentSnapshot? = nil, limit: Int) async throws -> ([Client], QueryDocumentSnapshot?) {
        ...
        // Methode für Klienten mit userID-Filterung (für Klienten)
        ...
        // Bestehende Methode anpassen, um die Rolle zu berücksichtigen
        func getClients(lastDocument: DocumentSnapshot? = nil, limit: Int) async throws -> ([Client], QueryDocumentSnapshot?) {
            ...
            // Hier könnten wir die Rolle des Benutzers prüfen, aber wir rufen direkt die passende Methode auf
